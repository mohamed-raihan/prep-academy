                ...
                <Col className='column1' lg={6}>
                    <div className='rectangle'>
                        ...
                        <div className='content w-75'>
                            <h3 className='text-light'>Classroom-Offline</h3>
                            <div className='content-child d-flex mt-5'>
                                <div><img width={'150px'} src={icon1} alt="" /></div><span className='text-light mt-4'>250 + Hours on CAT sessions & on non-CAT concepts.</span>
                            </div>
                            <div className='content-child d-flex'>
                                <div ><img width={'150px'} src={icon2} alt="" /></div>
                                <span className='text-light'>30 CAT + 70 non-CAT mocks 5600 topic-wise practice questions physical study material included.</span>
                            </div>
                            <div className='content-child d-flex'>
